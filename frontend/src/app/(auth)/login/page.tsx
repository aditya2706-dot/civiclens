        ...
        <main className="min-h-screen bg-gray-50 flex flex-col justify-center px-6 pb-20">
            ...
            >
                ...
                <form className="space-y-4">
                    ...
                    <button
                        type="button"
                        className="w-full bg-green-500 text-white font-bold py-4 rounded-2xl hover:bg-green-600 transition-colors shadow-lg shadow-green-200 flex justify-center items-center gap-2 mt-6"
                    >
